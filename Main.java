...
public class Main
{
	public static void main(String[] args) {
		...
		System.out.println("Enter 1 to go first and 2 to go second.");
		boolean turn; //turn true is player turn, false is computer turn
		if(reader.nextInt() == 1)
		    turn = true;
		else
		    turn = false;
		    
		//game stops when sticks = 0
		//game must keep running as long as sticks are greater than 10
	...
	public static int playerMove(int sticks, Scanner reader){
	    ...
	    if(take > 3)
	        ...
	        take = sticks;
	    System.out.println("You take " + take + " sticks.");
	    return sticks - take;
	}
